...
<head>
    ...
    <script>
        var recptchaKey = "{{env('GOOGLE_RECAPTCHA_KEY')}}"
    </script>
    <style>
        .grecaptcha-badge {
            visibility: hidden;
...
<body>
        ...
        <div class="get-in-touch">
            ...
            <ul class="contact-list list-inline">
                ...
                <li class="list-inline-item call">
                    <span>Reach Out</span>
                    <a href="+97333583355">+(973) 335-833-55</a>
                </li>
    ...
    <a href="tel:+97333583355" class="call-button"><img src="{{asset('assets/img/call-black.svg')}}" alt="Agency Contact"><span>+(973) 335 83355</span></a>
    <a href="https://wa.me/97333583355" class="whatsapp-mobile d-block d-sm-none img-fluid"><img src="{{asset('assets/img/whatsapp.svg')}}" alt="" alt="whatsapp"></a>
    <nav class="navbar @yield('navClass') navbar-expand-lg fixed-top navbar-light">
        <div class="container-fluid">
            <!--  dashboard first main logo for login page -->
            <a class="navbar-brand" href="{{route('homebeta')}}"><img src="@yield('logo')" class="img-fluid"></a>
    ...
    <div class="social-media">
        <div class="social-media-inner">
            <a href="{{route('homebeta')}}"><img src="{{asset('assets/img/logo.png')}}" alt="logo" class="img-fluid side-logo"></a>
            <ul>
